          ...
          <div className="flex items-center gap-3 text-slate-300">
            {onOpenStorePublish && (
              <button
                ...
                className="hover:text-white flex items-center gap-1.5 transition-colors cursor-pointer text-emerald-400 bg-slate-800/80 hover:bg-slate-800 px-2.5 py-0.5 rounded-full border border-slate-700"
              >
                <Smartphone className="w-3 h-3 text-emerald-400" />
                <span className="font-semibold text-[10px]">Play Store & App Store Ready</span>
              </button>
            )}
            <a
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="h-16 sm:h-18 flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              {/* Store & App Publishing Action */}
              {onOpenStorePublish && (
                <button
                  type="button"
                  onClick={onOpenStorePublish}
                  id="store-app-btn"
                  className="hidden sm:inline-flex items-center gap-1.5 px-3 py-2 text-xs font-bold text-slate-700 hover:text-blue-600 bg-slate-100 hover:bg-slate-200/80 rounded-xl transition-colors cursor-pointer"
            ...
            <div id="mobileMenu" className="lg:hidden py-4 border-t border-slate-100 flex flex-col gap-1.5 animate-in fade-in slide-in-from-top-2">
              ...
              {onOpenStorePublish && (
                <button
                  ...
                  className="text-left px-3 py-2 rounded-lg text-sm font-bold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 flex items-center justify-between"
                >
                  <span className="flex items-center gap-2">
                    <Smartphone className="w-4 h-4 text-emerald-600" />
                    <span>Play Store & App Store Ready</span>
                  </span>
                  <span className="text-[10px] bg-emerald-200 text-emerald-800 font-extrabold px-1.5 py-0.5 rounded">
                    100%
                  </span>
                </button>
              )}
